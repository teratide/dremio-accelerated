...
@Options
public class AcceleratedFilterPrel extends FilterRelBase implements Prel {

  public static final LongValidator RESERVE = new PositiveLongValidator("planner.op.accelerated_filter.reserve_bytes", Long.MAX_VALUE, DEFAULT_RESERVE);
  public static final LongValidator LIMIT = new PositiveLongValidator("planner.op.accelerated_filter.limit_bytes", Long.MAX_VALUE, DEFAULT_LIMIT);

  protected AcceleratedFilterPrel(RelOptCluster cluster, RelTraitSet traits, RelNode child, RexNode condition) {
  ...
  public org.apache.calcite.rel.core.Filter copy(RelTraitSet traitSet, RelNode input, RexNode condition) {
    return new AcceleratedFilterPrel(getCluster(), traitSet, input, condition);
  }
