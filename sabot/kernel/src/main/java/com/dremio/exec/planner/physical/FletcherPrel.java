...
@Options
public class FletcherPrel extends AggPrelBase implements Prel{
  ...
  private FletcherPrel(RelOptCluster cluster,
                      RelTraitSet traits,
                      RelNode child,
                      boolean indicator,
  ...
  public static FletcherPrel create(RelOptCluster cluster,
                                   RelTraitSet traits,
                                   RelNode child,
                                   boolean indicator,
                                   ImmutableBitSet groupSet,
    ...
    return new FletcherPrel(cluster, adjustedTraits, child, indicator, groupSet, groupSets, aggCalls, phase);
  }
