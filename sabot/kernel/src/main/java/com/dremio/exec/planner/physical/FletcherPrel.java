...
@Options
public class FletcherPrel extends FilterRelBase implements Prel {

  public static final LongValidator RESERVE = new PositiveLongValidator("planner.op.fletcher.reserve_bytes", Long.MAX_VALUE, DEFAULT_RESERVE);
  public static final LongValidator LIMIT = new PositiveLongValidator("planner.op.fletcher.limit_bytes", Long.MAX_VALUE, DEFAULT_LIMIT);

  protected FletcherPrel(RelOptCluster cluster, RelTraitSet traits, RelNode child, RexNode condition) {
  ...
  public org.apache.calcite.rel.core.Filter copy(RelTraitSet traitSet, RelNode input, RexNode condition) {
    return new FletcherPrel(getCluster(), traitSet, input, condition);
  }
