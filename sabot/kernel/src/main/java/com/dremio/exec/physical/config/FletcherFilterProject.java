...
@JsonTypeName("fletcher_filter_project")
public class FletcherFilterProject extends AbstractSingle {

  private final List<NamedExpression> exprs;

  @JsonCreator
  public FletcherFilterProject(
  ...
  public <T, X, E extends Throwable> T accept(PhysicalVisitor<T, X, E> physicalVisitor, X value) throws E{
    return physicalVisitor.visitFletcherFilterProject(this, value);
  }

  @Override
  protected PhysicalOperator getNewWithChild(PhysicalOperator child) {
    return new FletcherFilterProject(props, child, exprs);
  }
